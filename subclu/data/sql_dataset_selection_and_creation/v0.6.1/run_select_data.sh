...
# ETA: 6 seconds
#python select_data/__main__.py --query-name "_0a1_countrycode_name_mapping.sql" --no-log-query --end-date "'2022-10-24'" --run-id "20221027_1238"
...
# ETA: 18 seconds
#python select_data/__main__.py --query-name "_0b1_select_candidate_subs.sql" --no-log-query --end-date "'2022-10-24'" --run-id "20221027_1238"

# ETA: 5 to 9 seconds
#python select_data/__main__.py --query-name "_0b2_geo_relevance_baseline.sql" --no-log-query --end-date "'2022-10-24'" --run-id "20221027_1238"
...
#python select_data/__main__.py --query-name "_0b3_subreddit_relevance_raw.sql" --no-log-query --end-date "'2022-10-24'" --run-id "20221027_1238"


# ETA: ~35 seconds early in the morning (no load)
#  ~20 seconds on BQ UI early in the morning
#python select_data/__main__.py --query-name "_0b4_subreddit_relevance_standardized.sql" --no-log-query --end-date "'2022-10-24'" --run-id "20221027_1238"
...
# ETA: ~35 seconds
#python select_data/__main__.py --query-name "_0c1_select_geo_subreddits_for_modeling.sql" --no-log-query --end-date "'2022-10-24'" --run-id "20221027_1238"
...
python select_data/__main__.py --query-name "_01_select_subreddits.sql" --no-log-query --end-date "'2022-10-24'" --run-id "20221027_1238"
...
#     ~20 minutes -> 90 days
python select_data/__main__.py --query-name "_02_select_posts.sql" --no-log-query --end-date "'2022-10-24'" --run-id "20221027_1238"

# Get comments
# ETA: ~2.5 minutes -> 28 days
#     ~ 3 minutes -> 90 days
python select_data/__main__.py --query-name "_03_select_comments.sql" --no-log-query --end-date "'2022-10-24'" --run-id "20221027_1238"

# Merge posts + comments into single text field
# ETA: ~1 minute
python select_data/__main__.py --query-name "_04_combine_post_and_comment_text.sql" --no-log-query --end-date "'2022-10-24'" --run-id "20221027_1238"
...
python select_data/__main__.py --query-name "_01a_export_subreddits_to_gcs.sql" \
  --output-bucket-name "i18n-subreddit-clustering" --run-id "20221027_1238"
#  --run-id "20220406" \
#  --end-date "CURRENT_DATE() - 2"
